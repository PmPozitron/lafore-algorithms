...
class TSPApp
{
    public static void main(String[] args)
    {
        ...
        theGraph.addEdge(0, 2, 50);
        theGraph.addEdge(1, 2, 40);
        theGraph.addEdge(1, 5, 40);
        theGraph.addEdge(2, 1, 60);
        theGraph.addEdge(2, 4, 60);
        theGraph.addEdge(3, 4, 80);
        theGraph.addEdge(3, 6, 80);
        theGraph.addEdge(4, 0, 40);
        theGraph.addEdge(4, 1, 10);
        theGraph.addEdge(5, 6, 90);
        theGraph.addEdge(6, 7, 30);
        theGraph.addEdge(6, 3, 30);
        theGraph.addEdge(7, 3, 30);
